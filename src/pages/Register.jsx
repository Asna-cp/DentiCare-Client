...
const Register = () => {
  ...
  return (
    <div className="bg-opacity-10 dark:bg-opacity-10 min-h-screen flex items-center justify-center">
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-2 md:space-y-6 sm:p-8">
            ...
            >
              ...
              <p className="text-sm font-light mt-0 text-gray-500 dark:text-gray-400">
